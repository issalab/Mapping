...
def get_mappings_unit_test(M, D, Data_type, Data_params, reg_methods, reg_params_list, spearman_brown, report_sitefit, report_popfit):
    ...
    pickle.dump(data_list, open(resultdir + 'unit_test_%s_ni%d_nf%d_nt%d_collinearity%s_%s_SB%s_VariousSd%s_noisymap%s.pickle' % (
    reg_methods, ni, nf, nt, Collinearity, noise_dist, spearman_brown, various_unit_stds, noisy_map), 'wb'))
